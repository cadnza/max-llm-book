...
- [`Tensor.constant(data, dtype, device)`](https://docs.modular.com/max/api/python/experimental/tensor#max.tensor.Tensor.constant):
  Creates tensor from Python data

**Device transfer**:

- [`tensor.to(CPU())`](https://docs.modular.com/max/api/python/experimental/tensor#max.tensor.Tensor.to):
