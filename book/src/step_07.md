...
[`Tensor.arange`](https://docs.modular.com/max/api/python/experimental/tensor#max.tensor.Tensor.arange).
...
- [`Tensor.arange(seq_length, dtype, device)`](https://docs.modular.com/max/api/python/experimental/tensor#max.tensor.Tensor.arange):
